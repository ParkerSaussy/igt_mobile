...
import 'package:lesgo/app/modules/common_widgets/date_poll_detail_list.dart';
...
class DatePollDetailsView extends GetView<DatePollDetailsController> {
  const DatePollDetailsView({Key? key}) : super(key: key);
  @override
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              Obx(() => controller.lstTripDatePoll.value.isNotEmpty
                  ? DatePollDetailList(
                      lstDatePollDetail: controller.lstTripDatePoll.value,
                    )
                  : const SizedBox())
            ],
          ),
