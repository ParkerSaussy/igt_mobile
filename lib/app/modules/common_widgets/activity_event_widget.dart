...
class ActivityEventWidget extends StatelessWidget {
  const ActivityEventWidget({super.key, required this.activityDetailsModel});
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text(LabelKeys.eventLocationAddress.tr,
                            style: onBackGroundTextStyleMedium(),
                            overflow: TextOverflow.ellipsis),
                  ...
                  Padding(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text(LabelKeys.eventDescriptionDetails.tr,
                            style: onBackGroundTextStyleMedium(),
                            overflow: TextOverflow.ellipsis),
